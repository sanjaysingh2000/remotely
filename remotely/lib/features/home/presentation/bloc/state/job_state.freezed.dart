...
class _Initial implements JobState {
  const _Initial();
...
class _Loading implements JobState {
  const _Loading();
...
class _Success implements JobState {
  const _Success(final  List<JobEntity> jobs): _jobs = jobs;
...
@override
String toString() {
  return 'JobState.success(jobs: $jobs)';
}
...
/// @nodoc
abstract mixin class _$SuccessCopyWith<$Res> implements $JobStateCopyWith<$Res> {
...
class _Error implements JobState {
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $JobStateCopyWith<$Res> {
...
class _CachedJobs implements JobState {
  const _CachedJobs(final  List<JobEntity> jobs, this.message): _jobs = jobs;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$CachedJobsCopyWith<_CachedJobs> get copyWith => __$CachedJobsCopyWithImpl<_CachedJobs>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _CachedJobs&&const DeepCollectionEquality().equals(other._jobs, _jobs)&&(identical(other.message, message) || other.message == message));
}


@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_jobs),message);

@override
String toString() {
  return 'JobState.cachedJobs(jobs: $jobs, message: $message)';
}
...
/// @nodoc
abstract mixin class _$CachedJobsCopyWith<$Res> implements $JobStateCopyWith<$Res> {
  factory _$CachedJobsCopyWith(_CachedJobs value, $Res Function(_CachedJobs) _then) = __$CachedJobsCopyWithImpl;
@useResult
$Res call({
 List<JobEntity> jobs, String message
});
...
/// @nodoc
class __$CachedJobsCopyWithImpl<$Res>
    implements _$CachedJobsCopyWith<$Res> {
  __$CachedJobsCopyWithImpl(this._self, this._then);

  final _CachedJobs _self;
  final $Res Function(_CachedJobs) _then;

/// Create a copy of JobState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? jobs = null,Object? message = null,}) {
  return _then(_CachedJobs(
null == jobs ? _self._jobs : jobs // ignore: cast_nullable_to_non_nullable
as List<JobEntity>,null == message ? _self.message : message // ignore: cast_nullable_to_non_nullable
as String,
  ));
}
